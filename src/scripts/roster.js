...
<p>Eschyle s'est plongé en transe, mais n'a pour l'instant invoqué aucun esprit précis. D'après les instructions sommaires que vous avez reçues avant cette mascarade, vous êtes censés abattre vos cartes en même temps, sans savoir ce que l'autre vous prépare. Pour que le spectacle ne soit pas trop court, il vous a quand même été indiqué que vous aviez intérêt à balancer ce que vous avez de plus costaud dès le départ.</p>
...
<p>Au terme d'intenses réflexions, que vous avez eu tout le temps de mener alors que vous pourrissiez dans votre cellule, vous êtes arrivée à la conclusion que la liste des personnes capables de présentement vous prêter assistance se limite à trois noms seulement.</p>
`;
    ...
    "next": (goToSection) => {
      ...
      return (
        <div>
          ...
          {choice("first-onawa", {"onawaVersusMakabi": true}, "Onawa", onawaDescription)}
        </div>
      );
    },
  },
